...
class _ProfileInformationState extends State<ProfileInformation> {
  ...
  void initState() {
    ...
    _contactNumberProperties.controller.text = widget.user.secondaryNumber != null && widget.user.secondaryNumber.isNotEmpty? widget.user.secondaryNumber.substring(3) : '';
